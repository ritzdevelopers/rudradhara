    ...
    return (
        <section className="w-full relative h-[240px] sm:h-[280px] md:h-[320px] lg:h-[366px] overflow-hidden">
            <div className="absolute inset-0">
                <Image src={BANNER_SRC} alt="Products – Rudraksha and sacred items" fill className="hidden md:block object-cover" priority sizes="100vw" />
                <Image src={MOBILE_BANNER_SRC} alt="Products – Rudraksha and sacred items" fill className="block md:hidden object-cover" priority sizes="100vw" />
            </div>
