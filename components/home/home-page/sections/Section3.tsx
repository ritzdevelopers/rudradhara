...
function Section3() {
    return (
        <section className='w-full min-h-[400px] sm:min-h-[500px] md:min-h-[580px] lg:min-h-[632px] px-4 sm:px-8 md:px-12 xl:px-20 py-[40px] sm:py-[50px] lg:py-[60px] flex justify-center bg-[#EDD5A9]'>
            ...
            <div className='w-full main-container flex flex-col justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-[88px]'>
                ...
                <div className='flex flex-col sm:flex-row flex-wrap lg:flex-nowrap justify-center lg:justify-between gap-4 sm:gap-6 md:gap-8 lg:gap-2 xl:gap-4 2xl:gap-6 w-full max-w-full'>
                    {/* Circle 1  */} 
                    <div className='w-[240px] sm:w-[240px] md:w-[260px] lg:flex-1 lg:max-w-[275px] xl:max-w-[285px] 2xl:max-w-[300px] aspect-square border-[1px] border-dashed border-[#6C3E1A] crcle-container rounded-full overflow-hidden mx-auto shrink-0'>
                        <div className="w-full h-full rounded-full p-4 sm:p-6 md:p-8 flex flex-col justify-center items-center gap-1 sm:gap-2 text-center overflow-hidden">
                            <img src="/icons/arr2.png" alt="Selection" className='w-[32px] h-[32px] sm:w-[36px] sm:h-[36px] md:w-[40px] md:h-[40px] shrink-0'/>
                    ...
                    <div className='w-[240px] sm:w-[240px] md:w-[260px] lg:flex-1 lg:max-w-[275px] xl:max-w-[285px] 2xl:max-w-[300px] h-[240px] sm:h-[240px] md:h-[260px] lg:h-auto relative flex justify-center items-center mx-auto lg:mx-0 lg:-mt-8 shrink-0'>
                        ...
                        <div className="w-full h-full rounded-full p-4 sm:p-5 md:p-6 flex flex-col justify-center items-center gap-1 sm:gap-2 text-center overflow-hidden">
                            <img src="/icons/finder.png" alt="Identification" className='w-[32px] sm:w-[36px] md:w-[40px] h-auto shrink-0'/>
                    ...
                    <div className='w-[240px] sm:w-[240px] md:w-[260px] lg:flex-1 lg:max-w-[275px] xl:max-w-[285px] 2xl:max-w-[300px] h-[240px] sm:h-[240px] md:h-[260px] lg:h-auto relative flex justify-center items-center mx-auto lg:mx-0 lg:-mt-8 shrink-0'>
                        <div className='w-full max-w-[240px] sm:max-w-[240px] md:max-w-[260px] lg:max-w-full aspect-square border-[1px] border-dashed border-[#6C3E1A] crcle-container rounded-full overflow-hidden'>
                        <div className="w-full h-full rounded-full p-4 sm:p-6 md:p-8 flex flex-col justify-center items-center gap-1 sm:gap-2 text-center overflow-hidden">
                            <img src="/icons/electric.png" alt="Energisation" className='w-[32px] h-[32px] sm:w-[36px] sm:h-[36px] md:w-[40px] md:h-[40px] shrink-0'/>
