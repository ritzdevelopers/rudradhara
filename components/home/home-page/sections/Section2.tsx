                            ...
                            [
                                ...
                                return (
                                    <div key={idx} className='flex flex-col text-center w-full items-center max-w-[300px] mx-auto justify-between gap-2 md:gap-3'>
                                        ...
                                        <button className={`cursor-pointer h-[44px] sm:h-[48px] md:h-[50px] border-[#6C3E1A] border-[1px] rounded-[4px] flex justify-center items-center gap-2 px-3 hover:bg-[#6C3E1A] hover:text-white transition-colors group xl:${ob.btnWidth}`}>
