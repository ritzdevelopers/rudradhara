            ...
            <div className="w-full main-container flex flex-col gap-8 sm:gap-12 md:gap-16 lg:gap-[85px]">
                ...
                <div className='flex flex-col gap-4 sm:gap-6 md:gap-[25px]'>
                    ...
                    <div>
                        ...
                        {/* Cards Container  */}
                        <div className="flex flex-col sm:flex-row justify-center items-center gap-12 md:gap-12 lg:gap-[150px] -mt-8 sm:-mt-10 md:-mt-12 lg:-mt-14 px-4">
                            {[
                                {
                                ...
                                },
                                {
                                    ...
                                    return (
                                        <div key={idx} className='w-full sm:w-[250px] md:w-[270px] flex flex-col justify-center items-center gap-2 '>
                ...
                <div className="w-full flex flex-col lg:flex-row justify-center lg:justify-between items-center lg:items-start gap-8 lg:gap-4 xl:gap-6 2xl:gap-0">
                    {/* Left Side Container  */}
                    <div className="w-full lg:w-[600px] xl:w-[700px] 2xl:w-[800px] flex flex-col gap-12  md:gap-[30px] items-center lg:items-start">
                        ...
                        {/* Row 2  */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 md:gap-8 w-full">
                            {
                                [{
                                        ...
                                        <div key={idx} className='flex flex-col gap-2 sm:gap-3 items-center lg:items-start justify-between'>
                                            ...
                                            <div className="relative flex justify-center lg:justify-start" style={{ width: "auto", minHeight: `${ob.height}px` }}>
                                                <Image
                                                    src={ob.img}
                                                    alt={ob.ttl}
                                                    width={Number(ob.width) }
                                                    height={Number(ob.height)}
                                                />
                                            </div>
                                            <div className='flex flex-col gap-1 sm:gap-2 text-center lg:text-left'>
                                                ...
                                                <p className='text-[14px] font-[400] text-[#000000] font-open-sans'>{ob.para}</p>
                                            </div>
                                        </div>
                                    )
                                })}
                        ...
                        <div className='w-full flex justify-center lg:justify-start'>
                            <Link href="/learn-how-to-choose" target="_blank" rel="noopener noreferrer" className='cursor-pointer btn-slide2 w-[72%] md:w-auto sm:min-w-[200px] h-[44px] sm:h-[48px] md:h-[50px] bg-[#6C3E1A] rounded-[4px] flex justify-center items-center gap-2 px-3 hover:bg-[#5a3315] transition-colors'>
                    ...
                    <div className='hidden lg:block w-full lg:w-[350px] xl:w-[450px] 2xl:min-w-[539px] relative min-h-[400px] lg:min-h-[450px] xl:min-h-[520px] 2xl:min-h-[580px]'>
                ...
                <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 justify-center items-center">
                    ...
                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-6">
                        {
                            [
                                {
