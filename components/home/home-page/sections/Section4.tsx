        ...
        <section className="w-full px-4 sm:px-8 md:px-12 lg:px-20 py-[40px] sm:py-[50px] lg:py-[60px] flex justify-center items-center flex-col gap-4 sm:gap-5 md:gap-6">
            ...
            <div className="w-full main-container flex flex-col lg:flex-row justify-between gap-4 sm:gap-5 md:gap-6 mt-4">
                ...
                <div className="w-full lg:w-[428px] h-auto lg:h-[250px] border-[1px] border-[#D7D7D7] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 p-4 sm:p-5 md:p-6 rounded-[4px]">
                    ...
                    <div className="flex justify-center sm:justify-between gap-6 sm:gap-8 md:gap-10 lg:gap-12 w-full">
                ...
                <div className="w-full lg:w-[778px] h-[200px] sm:h-[220px] md:h-[240px] lg:h-[250px] bg-[url(/images/s4/s4img4.png)] bg-cover bg-no-repeat bg-center flex items-center justify-center lg:justify-start px-4 sm:px-6 md:px-8 rounded-[4px]">
                    <div className="flex flex-col gap-3 sm:gap-4 items-center lg:items-start text-center lg:text-left">
                        <h4 className="font-[700] text-[20px] sm:text-[24px] xl:text-[30px] text-white font-montserrat">Rudraksha should feel clear, <br /> not confusing.</h4>
            ...
            <div className="w-full flex flex-col lg:flex-row main-container justify-between items-center gap-6 sm:gap-8 md:gap-10 lg:gap-6 mt-4 sm:mt-5 md:mt-6">

                {/* Left Side Container  */}
                <div className="flex flex-col justify-between gap-4 sm:gap-5 md:gap-6 w-full lg:w-[600px] items-center lg:items-start">
                    {/* Top Container  */}
                    <div className="flex flex-col gap-3 sm:gap-4 text-center lg:text-left w-full">
                    ...
                    {/* Bottom Container  */}
                    <div className="w-full bg-[#EDD5A9] rounded-[4px] p-4 sm:p-6 md:p-8 flex flex-col gap-3 sm:gap-4 text-center lg:text-left">
                        <h6 className="font-[600] text-[18px] sm:text-[20px] md:text-[22px] lg:text-[24px] text-[#000000] font-montserrat">Start with understanding</h6>
                ...
                {/* Right Side Container  */}
                <div className="w-full lg:w-[606px] h-[300px] sm:h-[400px] md:h-[500px] lg:h-[583px] relative rounded-[4px] overflow-hidden">
