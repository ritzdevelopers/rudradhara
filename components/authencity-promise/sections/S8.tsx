...
function S8() {
    return (
        <section className="w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-20 relative flex justify-center items-center pb-8 sm:pb-10 md:pb-12 lg:pb-14 xl:pb-[70px]">
            ...
            <div className={`w-full h-auto py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16 relative flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 sm:gap-5 md:gap-6 lg:gap-0 border-[1px] border-[#F6DABC] p-4 sm:p-6 md:p-8 lg:p-[22px] xl:p-[25px] rounded-[4px] max-w-[1200px]`}>


                {/* Absolute Positioned Elips Image   */}

                <div className="absolute top-0 right-0 w-auto h-[100px] sm:h-[110px] md:h-[120px] lg:h-[130px] z-0 hidden lg:block 2xl:hidden">
                ...
                <div className="flex flex-col gap-3 sm:gap-3.5 md:gap-4 z-10">
                    <h3 className="font-[700] text-[18px] sm:text-[20px] md:text-[24px] lg:text-[28px] xl:text-[32px] text-center lg:text-left font-montserrat leading-tight sm:leading-snug md:leading-normal">Our promise is simple</h3>
