    ...
    return (
        <section className='w-full  flex flex-col items-center py-10 sm:py-12 md:py-14 lg:py-[70px] px-4 sm:px-6 md:px-8 lg:px-[35px] xl:px-[70px] gap-10 sm:gap-12 md:gap-14 lg:gap-[70px]'>
            ...
            <div className={`${styles.mainContainer} w-full flex flex-col lg:flex-row lg:justify-between gap-8 sm:gap-10 lg:gap-0`}>
                ...
                <div className='flex flex-col gap-4 sm:gap-5 lg:gap-4 w-full lg:w-auto'>
                    ...
                    <div className="flex flex-col w-full lg:w-[480px] text-center lg:text-left">
                        <h2 className="font-[700] text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-montserrat">
                            RudraDhara <br className='hidden lg:block'/> Mauritius
                        </h2>
                        <p className="font-[400] text-[14px] sm:text-[15px] lg:text-[16px] mt-2 sm:mt-3 font-poppins">
                    ...
                    <div className='flex flex-col sm:flex-row lg:flex-row justify-center lg:justify-start gap-4 sm:gap-6 lg:gap-0'>
                        {/* Card 1  */}
                        <div className='p-6 sm:p-7 lg:p-4 xl:p-8 border-[1px] border-[#E5E5E5] flex flex-col gap-4 sm:gap-5 lg:gap-[20px] text-left'>
                            <p className='font-[400] text-[24px] sm:text-[26px] lg:text-[30px] font-poppins'>In-store</p>

                            <div className='flex flex-col gap-5 sm:gap-6 lg:gap-[24px]'>
                                <p className='font-[400] text-[14px] sm:text-[15px] lg:text-[16px] font-poppins'>A calm, guided environment where:</p>
                                <ul className='flex flex-col gap-3 sm:gap-4 lg:gap-[14px]'>
                                    <li>
                                        <div className="flex items-center lg:items-start gap-3 sm:gap-4 lg:gap-[17px]">
                                            <img src="/icons/rudraksh-icn2.png" alt="Rudraksha Icon" className="w-[20px] h-[20px] sm:w-[22px] sm:h-[22px] lg:w-[23px] lg:h-[23px]  lg:mt-1 shrink-0" />
                                            <p className="font-[500] text-[16px] md:text-[17px] xl:text-[20px] text-[#6C3E1A] font-poppins">
                        ...
                        {/* Card 2  */}
                        <div className='p-6 sm:p-7 lg:p-4 xl:p-8 flex flex-col gap-4 sm:gap-5 lg:gap-[20px] text-left border-[1px] border-[#E5E5E5] lg:border-none'>
                ...
                <div className='w-full lg:w-[350px] lg:self-end xl:w-[422px] shrink-0'>
                    <div className="w-full flex justify-center items-center text-center py-5 sm:py-6 lg:py-6 px-6 sm:px-8 lg:px-12  border-[1px] border-[#E5E5E5]">
                        <p className='font-[400] text-[14px] sm:text-[15px] lg:text-[16px] font-poppins'>Whether online or in-store, the experience stays the same: <span className='font-[700]'>
            ...
            <div className={`${styles.mainContainer} w-full flex flex-col justify-center items-center gap-6 sm:gap-8 lg:gap-[35px] text-center px-4 sm:px-6 lg:px-0`}>
                <h6 className="font-[400] text-[24px] sm:text-[28px] md:text-[32px] lg:text-[34px] font-montserrat">
                    At RudraDhara, we keep the journey <br className="hidden sm:block" />
                    <span className="font-[700]"> simple, informed, and honest.</span>
                </h6>
                
                <Link href="/gallery" className="w-full max-w-[223px] h-[44px] sm:h-[48px] lg:h-[50px] flex justify-center items-center gap-2 rounded-[4px] font-[700] text-[14px] sm:text-[15px] lg:text-[16px] text-white cursor-pointer bg-[#6C3E1A] btn-slide2" onClick={() => { try { localStorage.setItem('scrollToAnchor', 'rudraksha'); } catch {} }}>
