...
function S4() {
    ...
    return (
        <section className="w-full relative block md:hidden lg:flex flex-col px-4 sm:px-6 md:px-8 lg:px-[35px] xl:px-[70px] py-10 sm:py-12 md:py-14 lg:py-[70px] gap-10 sm:gap-12 md:gap-14 lg:gap-[70px]">
                    ...
                    <SwiperSlide style={{ width: 'calc(100vw - 64px)', maxWidth: '330px' }}>
                        <div className="w-full bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                            ...
                            <div className="p-4 text-center">
                                <h6 className="font-[700] text-[16px] text-[#000000] mb-2 line-clamp-2 font-poppins">
                                    Rudraksha
                                </h6>
                                <p className="font-[400] text-[13px] text-[#4A4A4A] leading-relaxed line-clamp-3 font-poppins">
