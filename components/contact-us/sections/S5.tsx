                            ...
                            selectedFAQ.map((faq) => {
                                return (
                                    <li key={faq.id} className="w-full">
                                        <div key={faq.id} className="w-full flex flex-col gap-4 sm:gap-5 lg:gap-[20px] border-b-[1px] border-[#6C3E1A] pb-4 sm:pb-5 lg:pb-[20px] cursor-pointer relative pr-10 sm:pr-12 lg:pr-0" onClick={() => handleFAQClick(faq.id)}>
                                            <h6 className="font-[600] text-[16px] sm:text-[17px] lg:text-[18px] pr-8 sm:pr-10 lg:pr-0">{faq.question}</h6>
                                            {
                                                faq.isActive && (
                                            ...
                                            <div className="w-[24px] h-[24px] sm:w-[26px] sm:h-[26px] lg:w-[29px] lg:h-[29px] bg-[#6C3E1A] rounded-full absolute top-0 right-0 flex justify-center items-center">
                                                <img src="/icons/faq-arr.png" alt="" className={`w-[8px] h-[8px] sm:w-[9px] sm:h-[9px] lg:w-[10px] lg:h-[10px] transition-transform ${faq.isActive ? 'rotate-0' : '-rotate-90'}`} />
                                            </div>
                                        </div>
                                    </li>
                                )
