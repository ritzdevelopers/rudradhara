                ...
                <form className="w-full flex flex-col gap-4 sm:gap-5 lg:gap-[20px]">
                    ...
                    <div className="flex flex-col lg:flex-row lg:justify-between gap-6 sm:gap-8 lg:gap-[40px]">
                        ...
                        <div className="w-full lg:max-w-[446px] flex flex-col gap-4 sm:gap-5 lg:gap-[20px]">
                            <p className="font-[600] text-[18px] sm:text-[19px] lg:text-[20px]">I'm interested in...</p>
                                        ...
                                        map((item, index: number) => (
                                            <li key={index} className="w-full">
                                                ...
                                                >
                                                    ...
                                                    `}
                                                    />
                                                    <label htmlFor={`interest-${index}`} className={`text-[14px] sm:text-[15px] lg:text-[16px] font-[400] ${selectedInterest === index ? 'text-[#FFFFFF]' : 'text-[#000000]'} cursor-pointer`}>
                                                        {item.text}
